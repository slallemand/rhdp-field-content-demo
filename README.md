...
3. **Showroom Demo** (sync wave 20):
   ...
   - Uses official RHPDS `showroom-single-pod` chart (v2.1.7)
   - Single-pod deployment (faster, simpler)
   - Auto-builds from `showroom-content/` in this repo
   - Route: Auto-generated by Showroom deployer
